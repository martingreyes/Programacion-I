...
const routes: Routes = [
  ...
  { path: 'PerfilGrilla', component: PerfilGrillaComponent },
  { path: 'PerfilLista', component: PerfilListaComponent },
  { path: 'PerfilAjeno', component: PerfilAjenoComponent },
  { path: 'PerfilAjenoAdmin', component: PerfilAjenoAdminComponent },
  { path: 'PerfilAjenoUsuario', component: PerfilAjenoUsuarioComponent },
